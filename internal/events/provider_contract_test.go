...
var storedProviderContracts = map[string]providerContract{
	...
	"bgp_visibility":            {[]string{"country", "registered", "routed", "routed_ratio"}},
	...
	"firms":                     {[]string{"latitude", "longitude", "acq_date", "acq_time", "frp"}},
	...
	"gps_jamming":               {[]string{"h3_cell", "count_bad_aircraft", "intensity", "date"}},
	...
	"nws_alerts":                {[]string{"id", "event", "severity", "headline"}},
	...
	"ripe_ris":                  {[]string{"country", "updates", "withdrawals", "withdrawal_ratio"}},
	...
	"wmo_alert_hub":             {[]string{"id", "event", "headline", "member_country"}},
	"wmo_cap_alert_areas":       {[]string{"identifier", "event", "severity", "areaDesc"}},
